...
namespace IRI.Ket.KmlFormat.Primitives
{
    ...
    public abstract partial class AbstractGeometryType : AbstractObjectType
    {
        ...
        /// <remarks/>
        [XmlElement(typeof(ModelType), ElementName = "ModelType")]
        [XmlElement(typeof(PolygonType), ElementName = "PolygonType")]
        [XmlElement(typeof(LinearRingType), ElementName = "LinearRingType")]
        [XmlElement(typeof(LineStringType), ElementName = "LineStringType")]
        [XmlElement(typeof(PointType), ElementName = "PointType")]
        [XmlElement(typeof(MultiGeometryType), ElementName = "MultiGeometryType")]
