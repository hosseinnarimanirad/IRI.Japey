...
namespace IRI.Jab.Common.Presenter.Map
{
    public abstract class MapPresenter : BasePresenter
    {
        ...
        {
            var zoomInCursor = new System.Windows.Input.Cursor(System.Windows.Application.GetResourceStream(new Uri("/IRI.Jab.CommonCore;component/Assets/Cursors/MapCursorSet1/MagnifyPlusRightHanded.cur", UriKind.Relative)).Stream, false);
            ...
            var zoomOutCursor = new System.Windows.Input.Cursor(System.Windows.Application.GetResourceStream(new Uri("/IRI.Jab.CommonCore;component/Assets/Cursors/MapCursorSet1/MagnifyMinusRightHanded.cur", UriKind.Relative)).Stream, false);
