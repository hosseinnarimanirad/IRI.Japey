...
namespace IRI.Jab.Common.Helpers
{
    public static class ImageUtility
    {
        ...
        public static BitmapImage ToImage(byte[] array)
        {
            ...
            {
                System.Diagnostics.Trace.WriteLine($"IRI.Jab.Common > Helpers > ImageUtility > ToImage {ex.Message}");
                return null;
            }
        ...
        internal static BitmapSource AsBitmapSource(System.Drawing.Bitmap bitmap)
        {
        ...
        public static double GetOpacity(double opacity)
        {
