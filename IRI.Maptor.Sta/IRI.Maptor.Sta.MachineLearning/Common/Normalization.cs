...
public static class Normalization
{
    ...
    public static double[] NormalizeUsingZScore(double[] values, VarianceCalculationMode mode)
    {
        ...
        var mean = IRI.Maptor.Sta.Mathematics.Statistics.CalculateMean(values);

        var std = IRI.Maptor.Sta.Mathematics.Statistics.CalculateStandardDeviation(values, mode);
