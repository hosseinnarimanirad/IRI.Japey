...
namespace IRI.Maptor.Sta.Common.Contracts.Google;
...
public class GooglePlaces
{
    ...
    //{
    //    return IRI.Maptor.Sta.SpatialReferenceSystem.MapProjections.MapProjects.GeodeticWgs84ToWebMercator(AsGeodeticPoint());
    //}
    ...
    //{
    //    return (AsGeodeticBoundingBox().Transform(IRI.Maptor.Sta.SpatialReferenceSystem.MapProjections.MapProjects.GeodeticWgs84ToWebMercator));
    //}
}
