...
namespace IRI.Ket.ShapefileFormat.EsriType
{
    ...
    public struct PolyLine : ISimplePoints
    {
        ...
        public byte[] WriteContentsToByte()
        {
            ...
            result.Write(System.BitConverter.GetBytes((int)ShapeType.PolyLine), 0, ShapeConstants.IntegerSize);
        ...
        /// </summary>
        /// <returns></returns>
        static IRI.Ket.KmlFormat.Primitives.PlacemarkType AsPlacemark(PolyLine polyline, Func<IRI.Ham.SpatialBase.Point, IRI.Ham.SpatialBase.Point> projectToGeodeticFunc = null, byte[] color = null)
        {
        ...
        {
            return new PolyLine(this.Points.Select(i => i.Transform(transform)).Cast<EsriPoint>().ToArray(), this.Parts);
        }
    }
