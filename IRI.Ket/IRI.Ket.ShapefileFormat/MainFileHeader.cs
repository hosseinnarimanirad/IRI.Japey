...
namespace IRI.Ket.ShapefileFormat
{
    ...
    public struct MainFileHeader
    {
        ...
        public MainFileHeader(byte[] values)
        {
            ...
            this.m_Version = IRI.Ket.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToInt32(values, ShapeConstants.VersionOffset);

            this.m_ShapeType = IRI.Ket.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToInt32(values, ShapeConstants.ShapeTypeOffset);

            this.m_XMin = IRI.Ket.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.XMinOffset);

            this.m_YMin = IRI.Ket.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.YMinOffset);

            this.m_XMax = IRI.Ket.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.XMaxOffset);

            this.m_YMax = IRI.Ket.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.YMaxOffset);

            this.m_ZMin = IRI.Ket.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.ZMinOffset);

            this.m_ZMax = IRI.Ket.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.ZMaxOffset);

            this.m_MMin = IRI.Ket.Common.Helpers.StreamHelper.LittleEndianOrderedBytesToDouble(values, ShapeConstants.MMinOffset);
