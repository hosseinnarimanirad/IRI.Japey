...
namespace IRI.Ket.Graph.Clustring
{
    public class GreedyClustring<TNode, TWeight>
    {
        ...
        IRI.Ket.DataStructure.BinaryHeap<Edge<TNode, TWeight>> mostDesiredPairs;
        ...
        private void Initialize()
        {
            ...
            this.mostDesiredPairs = new IRI.Ket.DataStructure.BinaryHeap<Edge<TNode, TWeight>>(graph.GetEdges().ToArray(), compareFunction);
        }
