...
namespace IRI.Ket.Geometry
{
    public class DelaunayTriangulation
    {
        ...
        private void InitializeMembers(PointCollection points)
        {
            ...
            this.triangles = new QuasiTriangleCollection();
        }
        ...
        private void CreateBigTriangles()
        {
            ...
            this.lowerLeftIndex = this.points[this.points.Count - 4].GetHashCode();

            this.upperLeftIndex = this.points[this.points.Count - 3].GetHashCode();

            this.upperRightIndex = this.points[this.points.Count - 2].GetHashCode();

            this.lowerRightIndex = this.points[this.points.Count - 1].GetHashCode();

            QuasiTriangle firstBigTriangle = new QuasiTriangle(lowerRightIndex, upperRightIndex, lowerLeftIndex, this.triangles.GetNewCode());

            QuasiTriangle secondBigTriangle = new QuasiTriangle(upperRightIndex, upperLeftIndex, lowerLeftIndex, this.triangles.GetNewCode() + 1);
            ...
            this.triangles.Add(firstBigTriangle);

            this.triangles.Add(secondBigTriangle);
        }
        ...
        private void TrisectTriangle(QuasiTriangle temp, Point point)
        {
            ...
            this.triangles.Add(firsTriangle);
            ...
            this.triangles.Add(thirdTriangle);
        ...
        private void CheckForSwapEdge(ref Stack<KeyValuePair<QuasiEdge, QuasiTriangle>> stack)
        {
                                                        ...
                                                        points.GetPoint(currenTriangle.Third)) == PointCircleRelation.On)
            {
                ...
                if (IRI.Ham.Statistics.Statistics.GetMax(firstSetAngle) > IRI.Ham.Statistics.Statistics.GetMax(secondSetAngle) &&
                    IRI.Ham.Statistics.Statistics.GetMin(firstSetAngle) < IRI.Ham.Statistics.Statistics.GetMin(secondSetAngle))
                {
        ...
        private void RemoveBigTriangles()
        {
            ...
            this.points.RemoveByCode(lowerLeftIndex); this.points.RemoveByCode(upperLeftIndex);

            this.points.RemoveByCode(upperRightIndex); this.points.RemoveByCode(lowerRightIndex);
        }
        ...
        {
            QuasiTriangle temp = this.triangles.GetTriangle(triangleCode);

            return new Triangle(this.points.GetPoint(temp.First),
                                    this.points.GetPoint(temp.Second),
                                    this.points.GetPoint(temp.Third));
        }
        ...
        */
        ...
        {
            foreach (QuasiTriangle item in this.triangles)
            {
