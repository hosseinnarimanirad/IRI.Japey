...
namespace IRI.Tag.SampleWpfApp.ViewModel
{
    public class AppPresenter : MapApplicationPresenter<object>
    {
        ...
        public void ShowSpecialPointLayerSample()
        {
            ...
            {
                new Jab.Common.Locateable(new Point(48, 30), AncherFunctionHandlers.BottomCenter) { Element = new MapMarker("A") },
                new Jab.Common.Locateable(new Point(49, 31), AncherFunctionHandlers.BottomCenter) { Element = new MapMarker("B") },
                ...
                new Jab.Common.Locateable(new Point(52, 34), AncherFunctionHandlers.BottomCenter) { Element = new LabelMarker("E", true) }
            };
