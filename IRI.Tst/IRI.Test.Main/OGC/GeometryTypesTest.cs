...
namespace IRI.Test.Standards.OGC.SFA
{
    ...
    public class GeometryTypesTest
    {
        ...
        public void TestPoint()
        {
            ...
            IRI.Sta.Ogc.SFA.OgcGenericPoint<IRI.Sta.Ogc.SFA.OgcPoint> point =
                new IRI.Sta.Ogc.SFA.OgcGenericPoint<IRI.Sta.Ogc.SFA.OgcPoint>(geometry.AsBinaryZM().Buffer);
            ...
            IRI.Sta.Ogc.SFA.OgcGenericPoint<IRI.Sta.Ogc.SFA.OgcPointZ> pointZ =
                new IRI.Sta.Ogc.SFA.OgcGenericPoint<IRI.Sta.Ogc.SFA.OgcPointZ>(geometryZ.AsBinaryZM().Buffer);
            ...
            IRI.Sta.Ogc.SFA.OgcGenericPoint<IRI.Sta.Ogc.SFA.OgcPointZM> pointZM =
                new IRI.Sta.Ogc.SFA.OgcGenericPoint<IRI.Sta.Ogc.SFA.OgcPointZM>(geometryZM.AsBinaryZM().Buffer);
        ...
        public void TestLineString()
        {
            ...
            IRI.Sta.Ogc.SFA.OgcLineString<IRI.Sta.Ogc.SFA.OgcPoint> linestring =
                new IRI.Sta.Ogc.SFA.OgcLineString<IRI.Sta.Ogc.SFA.OgcPoint>(geometry.AsBinaryZM().Buffer);
            ...
            IRI.Sta.Ogc.SFA.OgcLineString<IRI.Sta.Ogc.SFA.OgcPointZ> linestringZ =
                new IRI.Sta.Ogc.SFA.OgcLineString<IRI.Sta.Ogc.SFA.OgcPointZ>(geometryZ.AsBinaryZM().Buffer);
            ...
            IRI.Sta.Ogc.SFA.OgcLineString<IRI.Sta.Ogc.SFA.OgcPointZM> linestringZM =
                new IRI.Sta.Ogc.SFA.OgcLineString<IRI.Sta.Ogc.SFA.OgcPointZM>(geometryZM.AsBinaryZM().Buffer);
        ...
        public void TestPolygon()
        {
            ...
            IRI.Sta.Ogc.SFA.OgcPolygon<IRI.Sta.Ogc.SFA.OgcPoint> polygon =
                new IRI.Sta.Ogc.SFA.OgcPolygon<IRI.Sta.Ogc.SFA.OgcPoint>(geometry.AsBinaryZM().Buffer);
            ...
            IRI.Sta.Ogc.SFA.OgcPolygon<IRI.Sta.Ogc.SFA.OgcPointZ> polygonZ =
                new IRI.Sta.Ogc.SFA.OgcPolygon<IRI.Sta.Ogc.SFA.OgcPointZ>(geometryZ.AsBinaryZM().Buffer);
            ...
            IRI.Sta.Ogc.SFA.OgcPolygon<IRI.Sta.Ogc.SFA.OgcPointZM> polygonZM =
                new IRI.Sta.Ogc.SFA.OgcPolygon<IRI.Sta.Ogc.SFA.OgcPointZM>(geometryZM.AsBinaryZM().Buffer);
