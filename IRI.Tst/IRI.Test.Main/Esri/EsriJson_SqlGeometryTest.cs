...
public class EsriJson_SqlGeometryTest
{
    ...
    public void TestEsriJson_SqlGeometryConversion()
    {
        try
        {
            ...
            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(point2D.AsWkt()).AsEsriJsonGeometry();
            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(point3D.AsWkt()).AsEsriJsonGeometry();
            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(pointNull.AsWkt()).AsEsriJsonGeometry();
            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(pointNaN.AsWkt()).AsEsriJsonGeometry();

            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(multipoint2D.AsWkt()).AsEsriJsonGeometry();
            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(multipoint3D.AsWkt()).AsEsriJsonGeometry();
            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(multipointEmpty.AsWkt()).AsEsriJsonGeometry();

            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(polyline2D.AsWkt()).AsEsriJsonGeometry();
            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(polyline3D.AsWkt()).AsEsriJsonGeometry();
            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(polylineEmpty.AsWkt()).AsEsriJsonGeometry();

            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(polygon2D.AsWkt()).AsEsriJsonGeometry();
            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(polygon3D.AsWkt()).AsEsriJsonGeometry();
            IRI.Ket.SqlServerSpatialExtension.Helpers.SqlSpatialHelper.Parse(polygonEmpty.AsWkt()).AsEsriJsonGeometry();
        }
        catch (Exception ex)
        {
