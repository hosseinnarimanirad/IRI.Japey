...
public class EsriShape_AsWkbTest
{
    ...
    public void InitializeTest()
    {
        ...
        this.polygonsZ = IRI.Sta.ShapefileFormat.Shapefile.ReadShapes(fileName2);
    ...
    public void TestEsriMultiPointToSqlServerWkb()
    {
        ...
        //Test MultiPointM
        IRI.Sta.ShapefileFormat.EsriType.EsriMultiPointM multiEsriPointM = new EsriMultiPointM(pointsM);
        ...
        //Test EsriPointZ
        IRI.Sta.ShapefileFormat.EsriType.EsriMultiPointZ multiEsriPointZ = new EsriMultiPointZ(pointsZ);
        SqlGeometry sqlEsriPointZ =
           SqlGeometry.STMPointFromText(
           new SqlChars(
