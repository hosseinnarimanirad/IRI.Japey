...
//        var shapes = IRI.Sta.ShapefileFormat.Shapefile.ReadShapes(shpFileName);

//        var IShape = shapes[0];

//        string value = IRI.Sta.Common.Helpers.XmlHelper.Parse(IShape.AsPlacemark());
//    }
...
//        string computedKml = IRI.Sta.ShapefileFormat.Shapefile.ReadShapes(shpFileName).AsKml();
