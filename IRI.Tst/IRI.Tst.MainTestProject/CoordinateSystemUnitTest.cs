...
namespace IRI.Test.MainTestProject
{
    ...
    public class CoordinateSystemUnitTest
    {
        ...
        public void TestGeodeticToAlbersEqualAreaConic()
        {
            ...
            double[][] actualResult = IRI.Msh.CoordinateSystem.MapProjection.MapProjects.GeodeticToAlbersEqualAreaConic(
                new double[] { lambda },
                new double[] { phi },
        ...
        public void TestLccNahrawan()
        {
            ...
            var result = IRI.Msh.CoordinateSystem.MapProjection.DefaultMapProjections.LccNahrawan.FromGeodetic(nahrawanGeodeticPoint);
